...
import bankexamp.BankTransactLocal; import 
java.io.IOException;
...
String selectedType = request.getParameter("transaction"); int amount = 
...
out.println(amount +" successfully Withdrawn. Your Balance is : 
...
private BankTransactLocal lookupBankTransactLocal() { try { 
